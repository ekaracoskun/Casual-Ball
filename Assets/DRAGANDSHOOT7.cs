...
public class DragAndShoot7 : MonoBehaviour
{
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        if (collision.gameObject.CompareTag("Ball"))
        {
            ...
            // Diðer topun yeni hýzýný da ayarla
            Vector2 otherVelocityAfterCollision = CalculateVelocityAfterCollision(otherRb, rb);

            rb.velocity = velocityAfterCollision;
            otherRb.velocity = otherVelocityAfterCollision;
        }
    }
